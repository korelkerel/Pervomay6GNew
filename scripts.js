window.addEventListener("scroll", function() {
    ...
    // Если проскроллили больше 100px вниз, добавляем класс "shrunk"
    if (scrollY > 100) {
  ...
  function moveBorder(el) {
    ...
    if (el.classList.contains('me')) { // для пункта "Me" ширина должна быть равна 50 пикселям
      newWidth = 70;
...
safety.innerText = 'Security built-in';
      ...
      textContent.innerText = '6G: Будущие Автономных и Иммерсивных Технологий';
